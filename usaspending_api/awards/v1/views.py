...
from usaspending_api.awards.serializers import NewAwardSerializer, AwardSerializer, SubawardSerializer, TransactionSerializer
...
class AwardViewSet(SuperLoggingMixin,
    ...
    serializer_class = NewAwardSerializer
